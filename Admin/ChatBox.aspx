<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ChatBox.aspx.cs" Inherits="ComplaintBox1.Admin.ChatBox" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <h2 align="center" style="color:black"> Query To Slove</h2>
    <table align="center">
                <tr>
                    <td>&nbsp</td>
                    <td>&nbsp</td>
